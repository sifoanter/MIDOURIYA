...
module.exports = {
 ...
 role: 0,
 shortDescription: {
 en: "قم بالتعرف على شريك حياتك",
 },
 longDescription : {
 en: "قم بالتعرف على مصيرك واعرف مع من ستكمل حياتك",
 },
 category: "حب",
 guide: {
 en: "{pn}"
...
const { loadImage, createCanvas } = require("canvas");
 ...
 return api.sendMessage({ body: `『💗』تهانينا ${name1}『💗』\『❤️』يبدو أن مصيرك جمعك مع ${name2}『❤️』\『🔗』نسبة الارتباط الخاصة بكما ${tile}%『🔗』`,
 mentions: [{
 tag: `${name2}`,
 id: id2
